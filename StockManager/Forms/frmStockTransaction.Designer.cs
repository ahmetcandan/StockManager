namespace StockManager
{
    partial class frmStockTransaction
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "stock-code";// $"{Translate.GetMessage("stock-code")} : ";
            ...
            this.label2.Text = "stock-name";// $"{Translate.GetMessage("stock-name")} : ";
            ...
            this.label3.Text = "amount";// $"{Translate.GetMessage("amount")} : ";
            ...
            this.label4.Text = "type";// $"{Translate.GetMessage("type")} : ";
            ...
            this.label5.Text = "date";// $"{Translate.GetMessage("date")} : ";
            ...
            this.label6.Text = "unit-price";// $"{Translate.GetMessage("unit-price")} : ";
            ...
            this.label7.Text = "total-price";// $"{Translate.GetMessage("total-price")} : ";
            ...
            this.Text = "stock-transaction";// Translate.GetMessage("stock-transaction");
