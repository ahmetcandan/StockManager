namespace StockManager
{
    partial class frmPeriod
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "period-name";// $"{Translate.GetMessage("period-name")} : ";
            ...
            this.label2.Text = "start-date";// $"{Translate.GetMessage("start-date")} : ";
            ...
            this.label3.Text = "end-date";// $"{Translate.GetMessage("end-date")} : ";
            ...
            this.Text = "save";// Translate.GetMessage("period");
