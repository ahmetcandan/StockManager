namespace StockManager
{
    partial class frmLogin
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnLogin.Text = "login";//Translate.GetMessage("login");
            ...
            this.btnCreate.Text = "create";// Translate.GetMessage("create");
            ...
            this.cbRememberUserName.Text = "remember-user-name";// Translate.GetMessage("remember-user-name");
            ...
            this.cbRememberPassword.Text = "remember-password";// Translate.GetMessage("remember-password");
            ...
            this.Text = "login";// Translate.GetMessage("login");
